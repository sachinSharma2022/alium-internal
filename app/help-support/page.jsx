...
const processSteps = [
  {
    stepNumber: "1",
    description: "Go to Settings and copy the tracking code snippet.",
  },
  {
    stepNumber: "2",
    description: "Sign in to your Google Tag Manager account.",
  ...
  },
  {
    stepNumber: "3",
    description:
      "Under the Tag Configuration section, select the Custom HTML option. This will be your tag type.",
    stepImg: "images/help-img1.svg",
    imgAlt: "Account process step guide image",
  },
  {
    stepNumber: "4",
    description: "Paste the code in the space provided.",
    stepImg: "images/help-img1.svg",
    imgAlt: "Account process step guide image",
  },
  {
    stepNumber: "5",
    description:
      "Now under the Triggering section, you can select your trigger conditions from the existing list of triggers.",
    stepImg: "images/help-img1.svg",
    imgAlt: "Account process step guide image",
    caption:
  ...
  {
    stepNumber: "6",
    description: "When you’re done, click on Save.",
    stepImg: "/images/help-img1.svg",
    imgAlt: "Account process step guide image",
  },
];
            ...
            <div className="w-full bg-white space-y-4 mt-4">
              ...
              <DisclosureItem title="What is the Alium Tracking Code?">
                <p className="text-tricorn-black text-base">
                  No, it won’t. At Alium we take site performance very seriously
                  and do everything in our power to optimize everything in the
                  process. Our tracking code us highly optimized to ensure fast
                  deliverability of our service on your sites with as little
                  impact as possible.
                </p>
              </DisclosureItem>
              {/* Item 2  */}
              <DisclosureItem title="Will Alium Slow Down My Site?">
                ...
                <ul className="text-primary-blue *:font-semibold *:text-base mt-4">
                  ...
                  <li>
                    <Link href="#">
                      2. How to Install your Alium Tracking Code within Google
                      Tag Manager
                    </Link>
                  </li>
                  <li>
                    <Link href="#">
                      3. How to Install your Alium Tracking Code within Shopify
                      Theme
                    </Link>
                  </li>
                </ul>
              ...
              {/* Item 3  */}
              <DisclosureItem title="How to Install your Alium Tracking Code"></DisclosureItem>
              ...
              <DisclosureItem title="Install within Google Tag Manager">
                <div className="text-tricorn-black text-base h-[6.75rem] flex flex-col justify-between">
                  <p>
                    Sick and tired of manually changing your website code every
                    time you want to embed a survey in your web pages? So are
                    we! With Google Tag Manager, you can incorporate the Alium
                    into your website without changing the site code.
                  </p>
              ...
              {/* Item 5  */}
              <DisclosureItem title="Install within Shopify Theme"></DisclosureItem>
            </div>
          </div>
        </section>
      </div>
